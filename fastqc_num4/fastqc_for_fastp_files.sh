...
OUTPUTFILESDIR="$WORKINGDIR/outputFiles/fastqcFiles_num4"
SAMPLELIST="$WORKINGDIR/rnaseqScripts/fastqc_num4/sampleListfromFastp_num4.tsv"
...
#to run: sbatch ../../rnaseqScripts/fastqc_num4/fastqc_for_fastp_files.sh
